...
const attachments = [
  { name: '에코뷰_서비스 점검 안내.pdf', size: '1.2 MB', type: 'PDF', cls: 'bg-[#FFF6F6] border-[#DE3412] text-[#DE3412]' },
              ...
              <div className="flex flex-col gap-[22px] pr-[120px]">
                <div className="flex flex-col gap-[10px]">
                  ...
                  <div className="flex flex-col gap-[4px]">
                    <h1 className="text-[32px] font-bold text-[#131416] leading-[1.5] tracking-[1px]">에코뷰 서비스 정기 점검 안내</h1>
                    <p className="text-[16px] text-[#464C53] leading-[1.5]">광명역세권 주요 건축물의 월별 에너지 사용량 및 탄소배출 추정 데이터를 제공합니다.</p>
                  </div>
                </div>
            ...
            <div className="border border-[#E6E8EA] rounded-[12px] bg-white overflow-hidden">
              <div className="px-[39px] pt-[31px] pb-[31px] flex flex-col gap-[24px] text-[16px] text-[#131416] leading-[1.5]">
                ...
                <div className="flex flex-col gap-[10px]">
                  ...
                  <div className="flex gap-[8px]"><span className="font-semibold shrink-0">점검 대상 :</span><span>에코뷰 데이터 지도, 데이터 목록, 연관플랫폼 일부 기능</span></div>
                ...
                <div className="bg-[#F6F9FF] border border-[#E5ECF9] rounded-[6px] px-[19px] py-[19px]">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-y-[8px] gap-x-[40px] text-[14px] text-[#131416]">
                    ...
                    <div className="flex gap-[16px]"><span className="font-semibold w-[56px] shrink-0">문의</span><span>에코뷰 운영관리자</span></div>
                  </div>
                </div>
              </div>
